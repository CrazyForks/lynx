...
# generate cmake 
gn gen out/gn_cmake_test --args="enable_unittests=true use_flutter_cxx=false" --ide=cmake --cmake-target="//lynx/tools/gn_tools/test:cmake_test"
# generate podspec 
gn gen out/gn_podspec_test --args="enable_unittests=true use_flutter_cxx=false" --ide=podspec --podspec-target="//lynx/tools/gn_tools/test:podspec_test"
